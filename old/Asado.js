...
class Asado extends Component {
  ...
  peopleCount = () => {
    const computed = this.state.user.men + this.state.user.women + this.state.user.children
  ...
  meatCount = () => {
    return this.round(
      this.state.user.men * 0.35 + this.state.user.women * 0.25 + this.state.user.children * 0.2
    )
  }

  sausageCount = () => {
    return this.round(
      this.state.user.men * 0.1 + this.state.user.women * 0.05 + this.state.user.children * 0.05
    )
  }
  ...
  carbonCount = () => {
    return this.round(this.meatCount() + (this.state.sausageSelected ? this.sausageCount() : 0))
  }
  ...
  eachPrice = () => {
    return this.round(this.totalPrice() / (this.state.user.men + this.state.user.women), -1)
  }
      ...
      <div className="Asado">
        <div className="Asado-wrapper">
          <div className="Asado-body">
                ...
                <div className="Asado-select-body Asado-select-body--column">
                  <div className="Asado-select-item">
                    <div className="Asado-input">
                      <select
                        onBlur={this.handleBudget.bind(this)}
                ...
                <div className="Asado-select-body">
                  ...
                  <h4>
                    <ul>
                      ...
                      {sausageSelected && <li>{sausageCount + 'kg de embutidos'}</li>}

                      {sausageSelected && <li>{breadCount + 'kg de pan'}</li>}

                      {carbonSelected && <li>{carbonCount + 'kg de carbón'}</li>}
                    </ul>
                  </h4>
                  <h4>
            ...
            <div className="Asado-help" onClick={this.handleHelp.bind(this)} aria-hidden="true">
              <h4>
                ¿Cómo funciona?{' '}
              ...
              {showHelp && (
                <>
                  <ul>
                    <li>
                      Se tomaron como referencias valores de supermercados Lider y Jumbo,
                      promediando estos valores y segmentando en 4 grupos para generar distintos
                      presupuestos.
                    </li>
                    <li>Solo se tomaron en cuenta carnes de vacuno al vacío.</li>
                    <li>No se consideran precios en oferta, solo valores normales.</li>
                    <li>
                      Salvo algunos casos existe una diferencia de hasta 2000 pesos entre tipo de
                      carne por segmento.
                    </li>
                    <li>
                      Para calcular cantidad de carne se consideran los siguientes gramos que come
                      comúnmente cada persona: 350 hombre, 250 mujer y 200 un niño.
                    </li>
                    <li>La división de valores considera solo adultos, los niños no pagan.</li>
                  </ul>
                  ...
                  <div>
                    ...
                    <ul>
                      <li>
                        Código fuente disponible para mejorar o modificar a gusto{' '}
                        <a href="https://github.com/raulghm/asadito">por acá</a>
                      </li>
                      <li>
                        Imagen de fondo tomada prestada{' '}
                        <a href="https://unsplash.com/photos/jeiqzOgwwKU">desde Unplash</a>
                      </li>
                    </ul>
                  </div>
                </>
